#############################################################################
# Makefile for building: firkcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon May 16 22:52:53 2016
# Project:  Firkcoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile Firkcoin-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/Firkcoin/src/leveldb/libleveldb.a /tmp/Firkcoin/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: Firkcoin-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile Firkcoin-qt.pro
...
/tmp/Firkcoin/src/leveldb/libleveldb.a: FORCE
	cd /tmp/Firkcoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/Firkcoin/build/build.h: FORCE
	cd /tmp/Firkcoin; /bin/sh share/genbuild.sh /tmp/Firkcoin/build/build.h
